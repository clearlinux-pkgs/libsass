...
Version  : 3.6.3
Release  : 21
URL      : https://github.com/sass/libsass/archive/3.6.3/libsass-3.6.3.tar.gz
Source0  : https://github.com/sass/libsass/archive/3.6.3/libsass-3.6.3.tar.gz
...
%prep
%setup -q -n libsass-3.6.3
cd %{_builddir}/libsass-3.6.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572917066
...
cp %{_builddir}/libsass-3.6.3/COPYING %{buildroot}/usr/share/package-licenses/libsass/dc6b6d4b9ae804ab0dd95d46d148ee533bec260f
cp %{_builddir}/libsass-3.6.3/LICENSE %{buildroot}/usr/share/package-licenses/libsass/4d640cc322117dec7f97632e6ed4319131a16ad2
%make_install
