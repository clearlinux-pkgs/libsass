...
Version  : 3.6.2
Release  : 20
URL      : https://github.com/sass/libsass/archive/3.6.2/libsass-3.6.2.tar.gz
Source0  : https://github.com/sass/libsass/archive/3.6.2/libsass-3.6.2.tar.gz
...
%prep
%setup -q -n libsass-3.6.2
cd %{_builddir}/libsass-3.6.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572559544
...
cp %{_builddir}/libsass-3.6.2/COPYING %{buildroot}/usr/share/package-licenses/libsass/dc6b6d4b9ae804ab0dd95d46d148ee533bec260f
cp %{_builddir}/libsass-3.6.2/LICENSE %{buildroot}/usr/share/package-licenses/libsass/4d640cc322117dec7f97632e6ed4319131a16ad2
%make_install
