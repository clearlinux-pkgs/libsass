...
Source0  : https://github.com/sass/libsass/archive/3.6.4/libsass-3.6.4.tar.gz
...
%prep
%setup -q -n libsass-3.6.4
cd %{_builddir}/libsass-3.6.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588652980
...
cp %{_builddir}/libsass-3.6.4/COPYING %{buildroot}/usr/share/package-licenses/libsass/dc6b6d4b9ae804ab0dd95d46d148ee533bec260f
cp %{_builddir}/libsass-3.6.4/LICENSE %{buildroot}/usr/share/package-licenses/libsass/4d640cc322117dec7f97632e6ed4319131a16ad2
%make_install
